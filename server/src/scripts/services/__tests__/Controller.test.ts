...
describe('services/Controller', () => {
  ...
  test('[generateFieldsFrom]', () => {
    ...
    expect(controller.generateFieldsFrom('test', [
      ...
      'arrayOne.dynamicObject.testOne._version',
      'arrayOne.dynamicObject.testOne._isDeleted',
      'arrayOne.dynamicObject.testOne._updatedBy',
      'arrayOne.dynamicObject.testOne._createdBy',
      'arrayOne.dynamicObject.testOne._updatedAt',
      'arrayOne.dynamicObject.testOne._createdAt',
