...
import { UITextfield } from 'scripts/vue/index';
...
const toPhone = (value: string, start: number): [string, (number | undefined)?] => {
...
<template>
  <div class="vgap-5">
    <main class="grid cols-1 hgap-3 vgap-5">
      <a href="/vue" class="cols-l-3">GO BACK</a>
      ...
      <UITextfield name="textfield6" label="ui-textfield with listener" :on-change="onChange" />
      <UITextfield name="textfield7" label="ui-textfield with blur listener" :on-blur="onBlur" />
