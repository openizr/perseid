...
declare module '@perseid/jobs/postgresql' {
  import type {
    Logger,
    Payload,
    CacheClient,
   ...
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/jobs/src/scripts/postgresql/services/PostgreSQLDatabaseClient.ts
   */
