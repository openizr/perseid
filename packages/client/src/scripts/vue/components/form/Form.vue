...
import Engine, { type FormState } from '@perseid/form';
import DefaultLoader from 'scripts/vue/components/form/DefaultLoader.vue';
import DefaultStep, { type FormStepProps } from 'scripts/vue/components/form/DefaultStep.vue';
import DefaultField, { type FormFieldProps } from 'scripts/vue/components/form/DefaultField.vue';
import DefaultLayout, { type FormLayoutProps } from 'scripts/vue/components/form/DefaultLayout.vue';
...
export interface FormProps {
  ...
  Layout?: DefineComponent<FormLayoutProps>;

  /** Default Step component to use. */
  Step?: DefineComponent<FormStepProps>;
...
const props = withDefaults(defineProps<FormProps>(), {
  ...
  Step: DefaultStep as unknown as undefined,
  Field: DefaultField as unknown as undefined,
  Loader: DefaultLoader as unknown as undefined,
  Layout: DefaultLayout as unknown as undefined,
});
