...
import { projectRootPath, isInstalled } from './helpers/paths.js';
...
const reactVersion = isInstalled('react') ? projectRequire('react/package.json').version : '19.0.0';
...
const config = [
  {
    ...
    settings: {
      ...
      'import-x/resolver-next': [
        createTypeScriptImportResolver({ project: tsconfigPath, extensions }),
      ],
    },
    rules: {
      // Best practices
