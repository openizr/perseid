...
declare module '@perseid/server' {
   ...
   * HTTP 400 error.
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/errors/BadRequest.ts
   */
   ...
   * HTTP 409 error.
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/errors/Conflict.ts
   */
   ...
   * HTTP 403 error.
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/errors/Forbidden.ts
   */
   ...
   * HTTP 410 error.
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/errors/Gone.ts
   */
   ...
   * HTTP 406 error.
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/errors/NotAcceptable.ts
   */
   ...
   * HTTP 404 error.
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/errors/NotFound.ts
   */
   ...
   * HTTP 429 error.
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/errors/TooManyRequests.ts
   */
   ...
   * HTTP 401 error.
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/errors/Unauthorized.ts
   */
   ...
   * HTTP 422 error.
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/errors/UnprocessableEntity.ts
   */
   ...
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/services/Profiler.ts
   */
   ...
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/services/Logger.ts
   */
   ...
   *
   * @linkcode https://github.com/openizr/perseid/blob/main/packages/server/src/scripts/core/services/CacheClient.ts
   */
  ...
  export interface ResourceMetadata {
     ...
     * sub-structures associated with that path. Several sub-structures can be associated to one
     * path, in the case of nested arrays in a relational DBMS. Used to know which entities need to
     * be deleted when updating or deleting a resource.
     */
